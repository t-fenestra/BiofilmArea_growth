...
PlotGALI<-IntegralArea_GALI %>% ggplot(aes(x=frame,y=IntAreaTotal,color=Strain))+
    geom_line(aes(group=data_stamp),size=2)+
    ggtitle('Integral area GALI') + 
    xlab("time frame in minutes") + ylab("Area")+
    theme_bw(base_size = 12)

ggarrange(PlotALI,PlotGALI,ncol=2, nrow =1,common.legend = TRUE, legend="bottom")
